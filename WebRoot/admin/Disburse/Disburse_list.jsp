						...
						if(rows.length ==0){
							$.messager.show({
								...
								showType:'slide'
									...
									//发送ajax请求
									$.post("Disburse-approvalIndemnify.action",{ids:ids,approvalId:editable},function(result){
										if(result =="true"){
							...
							if(rows.length ==0){
								$.messager.show({
									...
									showType:'slide'
										...
										var surl='<iframe src="Disburse_download.jsp?waybills='+waybills+'" frameborder="0" width="100%" height="100%"/>';
										console.info(surl);
										//1.弹出导出数据页面
										$("#win").window({
											title:'导出明细',
