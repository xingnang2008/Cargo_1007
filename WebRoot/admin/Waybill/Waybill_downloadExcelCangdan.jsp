...
<html>
	...
	$(function(){
		$("#btnCreate").click(function(){
			...
			if($("#ff").form("validate")){
				//提交数据				
				$('#ff').form('submit', {    
				    url:'Waybill/Waybill-downloadExcel.action',
				    onSubmit:function(){    
						$.messager.show({
						title:'请求已发送',
						msg:'请求已发送，请稍等。',
  ...
  <body>
    ...
    <div id="searchDiv">
			...
			<div id="hang">
				<select id="statusId" class="easyui-combobox" name="statusId"  data-options="panelHeight:'auto'" style="width:200px;">   
				    <option value="1">未配仓明细</option>   
				    <option value="2">配仓单</option>   				   
				</select>
			 </div>							
