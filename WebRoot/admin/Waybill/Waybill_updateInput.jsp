...
<html>
		 ...
		 $('#editable').attr('readonly',true);
			...
			$("#btnSave").click(function(){
				...
				if($("#ff").form("validate")){
					//提交数据
					$('#ff').form('submit', {    
					    url:'<%=basePath%>admin/Waybill/Waybill-update.action', 
  ...
  <body>
    ...
    <div class="container">
		<div id="top">	
		<input class="easyui-validatebox textbox" editable='false' required="required" validType="equals" name="editable" id="editable" style="width:50px;height:25px" />		
