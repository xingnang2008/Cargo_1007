...
<html>
	...
	$(function(){
		...
		$('#btnReset').click(function(){
			...
			$('#custName').textbox("clear"),
			$('#sender').textbox("clear")	
		
	});	
		$('#dg').datagrid({    
				//请求的url地址
			    url:'Waybill-findArrearages.action',
			    queryParams: {					
					sender:'sender'	,
					custName: 'custName'			
				},
			    ...
			    columns:[[  {field:'sender',title:'发货人',align:'center',width:80},
					        ...
					        {field:'fee',title:'欠款',align:'center',width:80}
				]]    
			},'json');
...
<div id="container">
		...
		<div id="searchDiv">
			<div class="line">
				...
				<div class="hang"><input type="text"  id="custName" class="easyui-textbox" name="custName"  style="width:100px"/></div>
