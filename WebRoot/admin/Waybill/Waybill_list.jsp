				...
				toolbar: [{
					...
					handler: function(){
						$("#win").window({
							...
							width:'1156',
							height:'80%',
							content:'<iframe src="Waybill_saveInput.jsp" frameborder="0" width="100%" height="100%"> </iframe>'
						});
					...
					},
					{
						...
						if(rows.length !=1){
							...
							$("#win").window({
								...
								width:'900',
								height:'650',
								content:'<iframe title="" src="Waybill_updateInput.jsp" frameborder="0" width="100%" height="100%"/>'
							});
					}}},
					'-',
					{
						...
						$("#win").window({
							...
							width:'500',
							height:'450',
							content:'<iframe title="导入数据" src="Waybill_Uploadfile.jsp" frameborder="0" width="100%" height="100%"/>'
						});
							...
							if(rows.length ==0){
								$.messager.show({
									...
									showType:'slide'
										...
										var surl='<iframe src="Waybill_downReportExcel.jsp?ids='+ids+'" frameborder="0" width="100%" height="100%"/>';
					...
					},
					{
						...
						if(rows.length !=1){
							...
							$("#win").window({
								...
								width:'100%',
								height:'100%',
								content:'<iframe title="" src="Waybill_print.jsp" frameborder="0" width="100%" height="100%"/>'
							});
					}}},
					{
						iconCls: 'icon-edit',
						...
						if(rows.length !=1){
							...
							$("#win").window({
								...
								width:'100%',
								height:'100%',
								content:'<iframe title="" src="Waybill_print2b.jsp" frameborder="0" width="100%" height="100%"/>'
							});
					}}},{
						iconCls: 'icon-more',
						text:'导出做价表',
							...
							if(rows.length ==0){
								$.messager.show({
									...
									showType:'slide'
										...
										ids = ids.substring(0,ids.lastIndexOf(","));
										//1.弹出导出数据页面downloadReport
										var surl='<iframe src="Waybill_downloadMakePrice.jsp?ids='+ids+'" frameborder="0" width="100%" height="100%"/>';
						...
						$("#win").window({
							...
							width:'500',
							height:'450',
							content:'<iframe title="导入数据" src="Waybill_UploadMakePricefile.jsp" frameborder="0" width="100%" height="100%"/>'
						});
